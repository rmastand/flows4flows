...
from utils import get_activation, get_data, get_flow4flow, train, train_batch_iterate, spline_inn, coupling_flow, set_penalty, \
    dump_to_df
...
def train_f4f_forward(*args, **kwargs):
    return train(*args, **kwargs, train_transfer = True, inverse=False)
